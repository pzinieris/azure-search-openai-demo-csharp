...
public sealed class QdrantEmbedService : AzureFormRecognizerDocumentParserService, IEmbedService
{
    ...
    public QdrantEmbedService(ILogger? logger, DocumentAnalysisClient documentAnalysisClient)
