...
public sealed class MilvusEmbedService : AzureFormRecognizerDocumentParserService, IEmbedService
{
    ...
    public MilvusEmbedService(ILogger? logger, DocumentAnalysisClient documentAnalysisClient)
